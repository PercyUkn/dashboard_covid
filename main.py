...
def init_callbacks(app):
    ...
    def plot_wordcloud(b):
        ...
        data_chatbot2.drop(data_chatbot2.loc[data_chatbot2['valor'] == '1'].index, inplace=True)
        data_chatbot2.drop(data_chatbot2.loc[data_chatbot2['valor'] == '2'].index, inplace=True)
        data_chatbot2.drop(data_chatbot2.loc[data_chatbot2['valor'] == '3'].index, inplace=True)
        data_chatbot2.drop(data_chatbot2.loc[data_chatbot2['valor'] == '4'].index, inplace=True)
        data_chatbot2.drop(data_chatbot2.loc[data_chatbot2['valor'] == '5'].index, inplace=True)
        data_chatbot2.drop(data_chatbot2.loc[data_chatbot2['valor'] == '6'].index, inplace=True)
        data_chatbot2.drop(data_chatbot2.loc[data_chatbot2['valor'] == '7'].index, inplace=True)
        data_chatbot2.drop(data_chatbot2.loc[data_chatbot2['valor'] == '8'].index, inplace=True)
        data_chatbot2.drop(data_chatbot2.loc[data_chatbot2['valor'] == '9'].index, inplace=True)
        data_chatbot2.drop(data_chatbot2.loc[data_chatbot2['valor'] == '10'].index, inplace=True)
